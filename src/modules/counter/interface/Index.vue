        ...
        <v-container fluid>
          <div class="d-flex flex-column align-center justify-center pa-6">
            ...
            <div class="d-flex align-center">
              <v-btn icon="mdi-minus" variant="outlined" @click="decrement"></v-btn>
              <div class="text-h3 mx-4">{{ count }}</div>
              <v-btn icon="mdi-plus" variant="outlined" @click="increment"></v-btn>
            </div>
          ...
          <div class="d-flex flex-column align-center justify-center pa-6">
            ...
            <div class="d-flex align-center">
              <v-text-field
                ...
                style="width: 120px"
              ></v-text-field>
              <v-btn icon="mdi-minus" variant="outlined" @click="decrementBy(step)"></v-btn>
              <div class="text-h3 mx-4">{{ count }}</div>
              <v-btn icon="mdi-plus" variant="outlined" @click="incrementBy(step)"></v-btn>
            </div>
            <v-btn class="mt-4" color="primary" @click="reset">Reset</v-btn>
          </div>
        </v-container>
